...
import com.rural.house.lg.dao.converters.ConverterDao;
import com.rural.house.lg.dao.impl.BookingDaoImpl;
import com.rural.house.lg.dao.impl.ReviewDaoImpl;
...
public class RuralHouseServiceApplication extends Application<RuralHouseServiceConfiguration> {
    ...
    public void run(RuralHouseServiceConfiguration configuration, Environment environment) throws Exception {
        ...
        BookingService bookingServiceImpl = new BookingServiceImpl(bookingDaoImpl, new AvailabilityCalculator(), configuration.getApplicationConfig().getRooms());
        ...
        environment.jersey().register(new BookingResourceImpl(bookingServiceImpl, new ModelMapper()));
